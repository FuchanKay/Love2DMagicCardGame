...
resource_display_module.newResourceDisplay = function(x, y, scale, init_arcane, init_hemo, init_holy, init_unholy)
    ...
    resource_display.subtractResource = function(card_type, num)
        ...
        elseif card_type == CardTypes.hemo then
            resource_display.hemo_num = resource_display.hemo_num - num < 0 and 0 or resource_display.arcane_num + num
        elseif card_type == CardTypes.holy then
            resource_display.holy_num = resource_display.holy_num - num < 0 and 0 or resource_display.arcane_num + num
        elseif card_type == CardTypes.unholy then
            resource_display.unholy_num = resource_display.unholy_num - num < 0 and 0 or resource_display.arcane_num + num
        end
    end
