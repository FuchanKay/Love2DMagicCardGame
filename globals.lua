...
function newBox(x, y, width, height, box_color, text, font, text_color, centered_x, centered_y)
...
function newButton(x, y, width, height, button_color, hot_color, text, font, text_color, centered_x, centered_y, on_pressed)
    -- if argument is nil, or X sets the property to X
    local button = {
        x = x or 0,
        y = y or 0,
